 ...
 * @returns {number}
 */
export function benchmark_hash(data, iterations) {
    const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.benchmark_hash(ptr0, len0, iterations);
    return ret;
}
 ...
 * @returns {number}
 */
export function benchmark_hash_rayon(data, iterations) {
    const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.benchmark_hash_rayon(ptr0, len0, iterations);
    return ret;
}
 ...
 * @returns {Uint8Array}
 */
export function derive_key(context, key_material, output_len) {
    ...
    const ret = wasm.derive_key(ptr0, len0, ptr1, len1, output_len);
 ...
 * @returns {Uint8Array}
 */
export function hash_rayon(data) {
    const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.hash_rayon(ptr0, len0);
    var v2 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
    wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
    return v2;
}
 ...
 * @returns {Uint8Array}
 */
export function hash_rayon_xof(data, output_len) {
    const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.hash_rayon_xof(ptr0, len0, output_len);
    var v2 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
    wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
    return v2;
}
 ...
 * @returns {Uint8Array}
 */
export function hash_xof(data, output_len) {
    const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.hash_xof(ptr0, len0, output_len);
    var v2 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
    wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
    return v2;
}
 ...
 * @returns {Uint8Array}
 */
export function keyed_hash(key, data) {
    const ptr0 = passArray8ToWasm0(key, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.keyed_hash(ptr0, len0, ptr1, len1);
    if (ret[3]) {
...
function __wbg_get_imports(memory) {
    ...
    imports.wbg.__wbg_log_e6096995941cf020 = function(arg0, arg1) {
